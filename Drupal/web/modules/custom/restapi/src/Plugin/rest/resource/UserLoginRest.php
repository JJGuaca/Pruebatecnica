    ...
    */
    public function post(Request $data) {
        ...
        try {
            ...
            $this->logger->error($this->t('Fallo en el LogIn, contactar admin .', ['%error' => $e->getMessage()]));
            $this->messenger->addMessage($this->t('Fallo en el LogIn, contactar admin .', ['%error' => $e->getMessage()]));
        }
    }
